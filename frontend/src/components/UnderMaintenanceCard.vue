      ...
      <div class="flex flex-wrap items-center">
        ...
        >
          <div class="px-4 py-20 xl:px-0">
            <div>
              <router-link to="/" class="mb-10 inline-flex">
              ...
              <p class="font-medium">Our website is under maintenance, wait for some time.</p>
            </div>
        ...
        <div class="hidden w-full lg:block lg:w-1/2">
          <div class="text-center">
            <span class="inline-block">
              <img src="@/assets/images/illustration/illustration-04.svg" alt="illustration" />
            </span>
          </div>
        </div>
      </div>
